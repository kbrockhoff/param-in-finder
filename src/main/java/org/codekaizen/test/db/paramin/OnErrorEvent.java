...
/**
 * Event fired when publisher wants to notify subscribers of a fatal failure.
 *
 * @author kbrockhoff
 */
class OnErrorEvent extends EventObject {

    private final Throwable throwable;

    OnErrorEvent(String senderId, Throwable throwable) {
        super(senderId);
