...
/**
 * Provides standard implementations of <code>Acceptor</code>.
 *
 * @author kbrockhoff
 */
public class Acceptors {
     ...
     * @return the acceptor
     */
    public static <T extends Comparable<? super T>> Acceptor<T> getAllAcceptor() {
        return value -> true;
    }
     ...
     * @return the acceptor
     */
    public static <T extends Comparable<? super T>> Acceptor<T> getValidListAcceptor(List<T> acceptableValues) {
     ...
     * @return the acceptor
     */
    public static <T extends Comparable<? super T>> Acceptor<T> getMinMaxAcceptor(T min, T max) {
        return value ->
     ...
     * @return the acceptor
     */
    public static Acceptor<String> getRegexStringAcceptor(Pattern pattern) {
